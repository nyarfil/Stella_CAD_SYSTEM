---
name: cadmcp-assembly
description: 組立・接続のCADレビュー。Req2CAD由来の実形状・検査記録をassemblyの観点で検証する。
model: inherit
readonly: true
is_background: false
---
...
Check locating versus retaining, mating interfaces, datum chains, assembly/disassembly paths, tool access and tolerance accumulation. Surface proximity alone does not prove assemblability.
...
"assembly" and use the supplied discussion_round. Describe actual execution as a
