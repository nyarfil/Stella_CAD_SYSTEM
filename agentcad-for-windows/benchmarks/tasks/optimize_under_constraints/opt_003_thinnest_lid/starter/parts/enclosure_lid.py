# Copied from examples/prototyping/parts/enclosure_lid.py into this project.
...
PARAMS = {
    ...
    "lid_t":    {"default": 3.0,   "min": 1.0,  "max": 6.0,   "unit": "mm",
                 "description": "Lid plate thickness"},
    "lip_h":    {"default": 3.0,   "min": 0.8,  "max": 6.0,   "unit": "mm",
