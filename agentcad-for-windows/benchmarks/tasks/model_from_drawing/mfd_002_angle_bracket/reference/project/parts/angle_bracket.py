...
# model_from_drawing/mfd_002_angle_bracket. A derived task copies the script
# INTO the bundle: the runner registers no examples, so a run can never read
# the answer. The rubric lives in ../../../specs/parts/angle_bracket.py and
# this script deliberately declares no SPECS of its own (design §1).
