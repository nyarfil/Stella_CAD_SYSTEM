# nema17 — NEMA 17 stepper motor outline

The NEMA 17 motor envelope (42.3 mm frame) as one parametric part:
...
|---|---|
| part id | `motor` |
| parameters | `body_length` (20–60 mm) |
...
|---|---|
| frame square | 42.3 |
| bolt pattern (square, centre to centre) | 31.0 |
| mounting holes | M3 tapped |
| pilot boss diameter | 22.0 |
| shaft diameter | 5.0 |

Common body lengths: 34, 40 and 48.
...
Apache-2.0. "NEMA 17" names a published frame size; no manufacturer's geometry
